<div>
    <div class="mb-6 sm:mb-8 text-center">
        <h2 class="text-lg sm:text-xl font-bold text-gray-900">Buat Akun Baru</h2>
        <p class="mt-2 text-xs sm:text-sm text-gray-600">Mulai kelola keuangan Anda hari ini</p>
    </div>

    <form wire:submit.prevent="register" class="space-y-4 sm:space-y-6">
        <!-- Name -->
        <div>
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="text" 
                    id="name"
                    class="block w-full pl-10 pr-3 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors @error('name') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
        ...
        <div>
            ...
            <div class="mt-2" x-data="{ 
                ...
                get strengthText() {
                    ...
                    return texts[this.strength] || 'Sangat Lemah';
                },
                get strengthColor() {
                ...
                <div class="flex items-center space-x-2">
                    <div class="flex-1 bg-gray-200 rounded-full h-2">
                        <div :class="strengthColor" class="h-2 rounded-full transition-all duration-300" :style="`width: ${(strength / 5) * 100}%`"></div>
                    </div>
                    <span class="text-xs text-gray-600" x-text="strengthText"></span>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="relative" x-data="{ showConfirmPassword: false }">
                ...
                <input 
                    ...
                    class="block w-full pl-10 pr-10 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors @error('password_confirmation') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
                ...
                <button 
                    ...
                    class="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <svg x-show="!showConfirmPassword" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
                    <svg x-show="showConfirmPassword" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-start space-x-3">
            <input type="checkbox" id="terms" class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 mt-0.5">
            <label for="terms" class="text-xs sm:text-sm text-gray-700 leading-relaxed">
                Saya setuju dengan 
                <a href="#" class="text-indigo-600 hover:text-indigo-500 transition-colors">Syarat & Ketentuan</a> 
                dan 
                <a href="#" class="text-indigo-600 hover:text-indigo-500 transition-colors">Kebijakan Privasi</a>
            </label>
        </div>
